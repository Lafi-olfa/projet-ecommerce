    ...
    <div className="checkout">
            ...
            <form class="go-right">
              ...
              <div>
                <input
                  ...
                  value={telephone}
                  id="telephone"
                  placeholder="Phone(+216)-00-000-000"
                  data-trigger="change"
                  data-validation-minlength="1"
                  data-type="number"
                  data-required="true"
        ...
        <div class="column column2">
          ...
          <div class="content" id="final_products">
            <div class="left" id="ordered">
                    ...
                    <div class="products">
                      ...
                      <td>
                        <div class="product_details">
                          <span class="product_name">{el.title}</span>
                        </div>
                      </td>
                      <td>
                        <span
                          style={{ fontSize: "15px", color: "red" }}
                        >{`Quantity:${el.qty}`}</span>
                      </td>
                      <hr />
                      <td>
                        <div
              ...
              <div class="final">
                <span class="title">
                  Total <span id="calculated_total">{`${total} $`}</span>
                </span>
              </div>
            </div>
          </div>
      ...
      <div>
        <form
          ...
          action="https://formspree.io/f/xnqreyke"
          method="POST"
        >
            ...
            <textarea
              ...
              defaultValue={cartItems.map(
                (data) =>
                  ...
                  data.qty +
                  ", price:" +
                  calculeRemise(data.price, data.promo).toFixed(2) +
                  "$" +
                  "\r"
              )}
